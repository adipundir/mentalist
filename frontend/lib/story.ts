...
export interface Chapter extends CaseConfig {
  n: number;
  /**
   * Who each suspect speaks about, as a seat bitmask.
   *
   * Every suspect gives exactly one statement, and it is always about the same people. The
   * enclave computes whether the killer is among them and flips that answer by the
   * speaker's hidden honesty bit, so what you hear is the claim, not the fact.
   *
   * These are searched rather than chosen: for each case, the assignment that leaves the
   * fewest suspects standing once every statement is in. They do not always leave exactly
   * one, which is the point. When two men are still possible you are betting, not solving.
   */
  claims: number[];
...
export const CHAPTERS: Chapter[] = [
  {
    ...
    nudge: {
      speaker: "lisbon",
      line: "Walk up to a man and let him talk. Each of them says one thing, and then he's said it.",
    },
  },
  {
    n: 6,
    ...
    nudge: {
      speaker: "vanpelt",
      line: "Two of them will name the same people. If their stories point opposite ways, one of them is lying.",
    },
  },
  {
    n: 8,
    ...
    nudge: {
      speaker: "cho",
      line: "Anyone who puts himself in the frame is lying, and lying to protect someone. Red John never would.",
    },
  },
  {
    n: 7,
    ...
    nudge: {
      speaker: "lisbon",
      line: "Count the liars their stories imply. Only one name leaves you with the right number of them.",
    },
  },
  {
    n: 6,
    ...
    nudge: {
      speaker: "rigsby",
      line: "Boss, four of these six would lie to a federal agent without blinking. Assume the room is against you.",
    },
  },
  {
    n: 5,
    ...
    nudge: {
      speaker: "cho",
      line: "There's one truthful mouth in that room. Everything else you hear is somebody protecting him.",
    },
  },
  {
    n: 3,
    ...
    nudge: {
      speaker: "abbott",
      line: "Mr. Jane. Whatever you're about to do in there, do it with the evidence, and not with the gun.",
    },
  },
];
